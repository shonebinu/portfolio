...
export const about: About = {
  ...
  // parses html
  description:
    "I’m a recent <u>Software Engineer</u> graduate who likes to keep tackling new problems. Currently, I’m working on the <u>React and Node.js</u> side of things. Outside of this, I work on improving myself in whatever I see fit.",
  links: [
    // Lucide icons
...
export const projects: Project[] = [
  {
    ...
    description:
      "Currently Building: Penweave is a CodePen‑like tool that lets users run their HTML/CSS/JS in a browser environment with secure preview and sharing.",
